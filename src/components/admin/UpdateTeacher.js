      ...
      .then((response) => {
        ...
        if (response.data.code == "2047") {
          ...
          this.setState({
            ...
            old_section: teacherData.section,
            new_section: teacherData.section,
          });
        }
      })
      .catch((error) => {
    ...
    axios({
      ...
      data: {
        ...
        data: {
          ...
          "old-section": this.state.old_section,
          "new-section": this.state.new_section,
          ...
          this.setState({
            ...
            errorContent: (
              <Alert
                type="success"
                symbol="Updated"
                text="Teacher data is successfully updated"
              ></Alert>
            ),
          });
        }
      ...
      <Fragment>
        ...
        <div className="container mt-4">
          {this.state.userRedirect ? (
            <Redirect to="/user/admin/teacher"></Redirect>
          ) : (
            ""
          )}
          {this.state.loadingStatus ? (
            ...
            <Fragment>
              <h1 className="text-center">
                Update teacher {this.state.location}
              </h1>
              <form onSubmit={this.updateData}>
                ...
                <div className="row mb-3">
                  <label className="col-12 col-sm-3 col-lg-1 col-form-label">
                    Section
                  </label>
                  <div className="col">
                    <select

            ...
            <div className="container mt-4">
              ...
              <div>
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="row mb-3">
                      <label htmlFor="inputEmail3" className="col-12 col-sm-3 col-lg-1 col-form-label">Userid</label>
                      <div className="col">
                    ...
                    <div className="row mb-3">
                      ...
                      <div className="col">
                          <input type="text" value={this.state.class} className="form-control" disabled/>
                       </div>
                    </div>

                    <div className="row mb-3">
                      <label htmlFor="inputEmail3" className="col-12 col-sm-3 col-lg-1 col-form-label">Section</label>
                      <div className="col">
                          <input type="text" value={this.state.section} className="form-control" disabled/>
                       </div>
                    </div>

                    <div className="row mb-3">
                      <label htmlFor="inputEmail3" className="col-12 col-sm-3 col-lg-1 col-form-label">Contact No</label>
                      <div className="col">
                          <input type="text" value={this.state.contactno} className="form-control" disabled/>
                       </div>
                    </div>
